...
import net.jeeshop.services.common.Account;
...
public class MailUtil {
	...
	public static void main(String[] args) {//huangf@spider.com.cn
		MailUtil mail = new MailUtil("18072750740@163.com",
				"18072750743@163.com","xiakai21060138", "smtp.163.com", "夏凯");
		mail.attachfile("f:\\1.jpg");
		//mail.startSend(getForgetHtml(null));
		mail.startSend("test","test");
		System.out.println("发送成功");
	}

	// 定义发件人、收件人、主题等
	String to = null;
	String from = "18072750743@163.com";
	String password = "xiakai21060138";
